        ...
        return (
            <div className="wrapper">
                        ...
                        <Fragment>
                            ...
                            <div id="information">
                                ...
                                <div>
                                    ...
                                    <span className={`cat_name ${category}`}>
                                        {category}
                                    </span>
                                    {appearance && (
                ...
                <footer className="footer center">
                    <span className="barcode">727</span>
                    <span>
                        An ElectronJS fork of{" "}
                        <a
                        ...
                        by{" "}
                        <a
                            href="https://github.com/laex2112"
                            target="_blank"
                            rel="noopener"
                        >
                            Dao Thinh Khang
                        ...
                        and{" "}
                        <a
                            href="https://github.com/khokhonguyen"
                            target="_blank"
                            rel="noopener"
                        >
                            Nguyen Thanh Khoi
                    ...
                    <GitHubButton
                        href="https://github.com/laex2112/periodic-table"
                        data-color-scheme="no-preference: light; light: light; dark: dark;"
                        data-icon="octicon-comment-discussion"
                        data-size="large"
                        aria-label="Discuss laex2112/periodic-table on GitHub"
                    >
                        Discuss
                    </GitHubButton>
                </footer>
